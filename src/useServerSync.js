...
function packetToCommonSample(packet, fallbackSource = 'unknown', stats = {}) {
  ...
  return {
    ...
    enc_age_x: firstFinite([src.enc_age_x, src.encoderAgeX, src.encoder?.ageX, src.encoder?.age_x], null),
    enc_age_y: firstFinite([src.enc_age_y, src.encoderAgeY, src.encoder?.ageY, src.encoder?.age_y], null),
    enc_age_z: firstFinite([src.enc_age_z, src.encoderAgeZ, src.encoder?.ageZ, src.encoder?.age_z], null),
    ...
    encoderAgeX: firstFinite([src.encoderAgeX, src.enc_age_x, src.encoder?.ageX, src.encoder?.age_x], null),
    encoderAgeY: firstFinite([src.encoderAgeY, src.enc_age_y, src.encoder?.ageY, src.encoder?.age_y], null),
    encoderAgeZ: firstFinite([src.encoderAgeZ, src.enc_age_z, src.encoder?.ageZ, src.encoder?.age_z], null),
    ...
    commandType: firstFinite([src.commandType, src.command_type], null),
    command_type: firstFinite([src.command_type, src.commandType], null),
    ...
    timestamp_us: firstFinite([src.timestamp_us, src.remote_timestamp_us, src.timestamp], null),
    remote_timestamp: firstFinite([src.remote_timestamp, src.timestamp, src.ebimu_timestamp_ms, src.ebimuTimestampMs], null),
    remote_timestamp_us: firstFinite([src.remote_timestamp_us, src.timestamp_us, src.timestamp], null),
