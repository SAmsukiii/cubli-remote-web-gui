...
const DEFAULT_PACKET = {
  ...
  encoderYawDeg: null,
  enc_roll_raw_deg: null,
  enc_pitch_raw_deg: null,
  enc_yaw_raw_deg: null,
  ...
  encoderAlignmentSource: '',
  encoder_alignment_updated_at_ms: null,
  encoderAlignmentUpdatedAtMs: null,
  encoder_alignment_sat_seq: null,
  encoderAlignmentSatSeq: null,
  encoder_alignment_sat_timestamp_us: null,
  encoderAlignmentSatTimestampUs: null,
  encoderRpySource: '',
  rawRollDeg: 0,
  rawPitchDeg: 0,
  rawYawDeg: 0,
  ...
  encoder: {
    ...
    yawDeg: null,
    rollAlignedDeg: null,
    pitchAlignedDeg: null,
    yawAlignedDeg: null,
    dotRaw: null,
    dotAbs: null,
    thetaErrDeg: null,
    alignmentSource: '',
    alignmentUpdatedAtMs: null,
    alignmentSatSeq: null,
    alignmentSatTimestampUs: null,
...
function makeEncoderFields(input = {}, fallback = {}, options = {}) {
  ...
  const rawUpdatedAt = firstFiniteValue([input.encoderUpdatedAt, input.encoder?.updatedAt], fallbackValue('encoderUpdatedAt', 'encoderUpdatedAt', 'updatedAt'));
  ...
  const updatedAt = rawUpdatedAt ?? (hasData ? now : null);
...
function mergeEncoderIntoPacket(packet = {}, encoder = {}, options = {}) {
  ...
  return attachEncoderAlignment({
    ...
    now: options.now,
    encoderEulerSequence: options.encoderEulerSequence,
    encoderDisplayRollSign: options.encoderDisplayRollSign,
    encoderDisplayPitchSign: options.encoderDisplayPitchSign,
    encoderDisplayYawSign: options.encoderDisplayYawSign,
...
export default function useEsp32Serial(options = {}) {
  ...
  const registerValidPacketRefOnly = useCallback((parsed) => {
    if (parsed.encoderOnly) {
      ...
      const encoderCsvPacket = attachEncoderAlignment(patchPacketWithDesired({
        ...
        timestamp: Number.isFinite(parsed.timestamp) ? parsed.timestamp : latestPacketRef.current.timestamp,
        seq: Number.isFinite(parsed.seq) ? parsed.seq : latestPacketRef.current.seq,
        updatedAt: now,
      ...
      pushCsvLogPacket(encoderCsvPacket);
      ...
      const chartPoint = {
        ...
        satQ0: latestPacketRef.current.sat_q0 ?? latestPacketRef.current.q0 ?? latestPacketRef.current.q?.[0],
        satQ1: latestPacketRef.current.sat_q1 ?? latestPacketRef.current.q1 ?? latestPacketRef.current.q?.[1],
        satQ2: latestPacketRef.current.sat_q2 ?? latestPacketRef.current.q2 ?? latestPacketRef.current.q?.[2],
        satQ3: latestPacketRef.current.sat_q3 ?? latestPacketRef.current.q3 ?? latestPacketRef.current.q?.[3],
        encX: latestPacketRef.current.enc_x_deg,
        encY: latestPacketRef.current.enc_y_deg,
        encZ: latestPacketRef.current.enc_z_deg,
        encoderRoll: latestPacketRef.current.encoderHasQuaternion ? latestPacketRef.current.encoderRollDeg : null,
        encoderPitch: latestPacketRef.current.encoderHasQuaternion ? latestPacketRef.current.encoderPitchDeg : null,
        encoderYaw: latestPacketRef.current.encoderHasQuaternion ? latestPacketRef.current.encoderYawDeg : null,
        encQ0: latestPacketRef.current.enc_q0 ?? latestPacketRef.current.encoderQ0,
        encQ1: latestPacketRef.current.enc_q1 ?? latestPacketRef.current.encoderQ1,
        encQ2: latestPacketRef.current.enc_q2 ?? latestPacketRef.current.encoderQ2,
        encQ3: latestPacketRef.current.enc_q3 ?? latestPacketRef.current.encoderQ3,
        encQ0Raw: latestPacketRef.current.enc_q0_raw ?? latestPacketRef.current.encoderQ0Raw ?? latestPacketRef.current.enc_q0 ?? latestPacketRef.current.encoderQ0,
        encQ1Raw: latestPacketRef.current.enc_q1_raw ?? latestPacketRef.current.encoderQ1Raw ?? latestPacketRef.current.enc_q1 ?? latestPacketRef.current.encoderQ1,
        encQ2Raw: latestPacketRef.current.enc_q2_raw ?? latestPacketRef.current.encoderQ2Raw ?? latestPacketRef.current.enc_q2 ?? latestPacketRef.current.encoderQ2,
        encQ3Raw: latestPacketRef.current.enc_q3_raw ?? latestPacketRef.current.encoderQ3Raw ?? latestPacketRef.current.enc_q3 ?? latestPacketRef.current.encoderQ3,
        encoderRollAligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_roll_aligned_deg : null,
        encoderPitchAligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_pitch_aligned_deg : null,
        encoderYawAligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_yaw_aligned_deg : null,
        encQ0Aligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_q0_aligned : null,
        encQ1Aligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_q1_aligned : null,
        encQ2Aligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_q2_aligned : null,
        encQ3Aligned: latestPacketRef.current.enc_valid ? latestPacketRef.current.enc_q3_aligned : null,
        dotRaw: latestPacketRef.current.dot_raw,
        dotAbs: latestPacketRef.current.dot_abs,
        thetaErr: latestPacketRef.current.theta_err_deg,
    ...
    const commonPacket = patchPacketWithDesired({
      ...
      enc_q0_raw: normalizedPacket.enc_q0_raw,
      enc_q1_raw: normalizedPacket.enc_q1_raw,
      enc_q2_raw: normalizedPacket.enc_q2_raw,
      enc_q3_raw: normalizedPacket.enc_q3_raw,
      enc_q0_aligned: normalizedPacket.enc_q0_aligned,
      enc_q1_aligned: normalizedPacket.enc_q1_aligned,
      enc_q2_aligned: normalizedPacket.enc_q2_aligned,
      enc_q3_aligned: normalizedPacket.enc_q3_aligned,
      ...
      encoderQ0Raw: normalizedPacket.encoderQ0Raw,
      encoderQ1Raw: normalizedPacket.encoderQ1Raw,
      encoderQ2Raw: normalizedPacket.encoderQ2Raw,
      encoderQ3Raw: normalizedPacket.encoderQ3Raw,
      encoderQ0Aligned: normalizedPacket.encoderQ0Aligned,
      encoderQ1Aligned: normalizedPacket.encoderQ1Aligned,
      encoderQ2Aligned: normalizedPacket.encoderQ2Aligned,
      encoderQ3Aligned: normalizedPacket.encoderQ3Aligned,
      ...
      enc_roll_raw_deg: normalizedPacket.enc_roll_raw_deg,
      enc_pitch_raw_deg: normalizedPacket.enc_pitch_raw_deg,
      enc_yaw_raw_deg: normalizedPacket.enc_yaw_raw_deg,
      enc_roll_aligned_deg: normalizedPacket.enc_roll_aligned_deg,
      enc_pitch_aligned_deg: normalizedPacket.enc_pitch_aligned_deg,
      enc_yaw_aligned_deg: normalizedPacket.enc_yaw_aligned_deg,
      encoderRollAlignedDeg: normalizedPacket.encoderRollAlignedDeg,
      encoderPitchAlignedDeg: normalizedPacket.encoderPitchAlignedDeg,
      encoderYawAlignedDeg: normalizedPacket.encoderYawAlignedDeg,
      dot_raw: normalizedPacket.dot_raw,
      dot_abs: normalizedPacket.dot_abs,
      theta_err_deg: normalizedPacket.theta_err_deg,
      enc_age_ms: normalizedPacket.enc_age_ms,
      enc_valid: normalizedPacket.enc_valid,
      encoder_alignment_source: normalizedPacket.encoder_alignment_source,
      encoder_alignment_updated_at_ms: normalizedPacket.encoder_alignment_updated_at_ms,
      encoder_alignment_sat_seq: normalizedPacket.encoder_alignment_sat_seq,
      encoder_alignment_sat_timestamp_us: normalizedPacket.encoder_alignment_sat_timestamp_us,
    ...
    const chartPoint = {
      ...
      satQ0: commonPacket.sat_q0 ?? commonPacket.q0 ?? commonPacket.q?.[0],
      satQ1: commonPacket.sat_q1 ?? commonPacket.q1 ?? commonPacket.q?.[1],
      satQ2: commonPacket.sat_q2 ?? commonPacket.q2 ?? commonPacket.q?.[2],
      satQ3: commonPacket.sat_q3 ?? commonPacket.q3 ?? commonPacket.q?.[3],
      ...
      encQ0: commonPacket.enc_q0 ?? commonPacket.encoderQ0,
      encQ1: commonPacket.enc_q1 ?? commonPacket.encoderQ1,
      encQ2: commonPacket.enc_q2 ?? commonPacket.encoderQ2,
      encQ3: commonPacket.enc_q3 ?? commonPacket.encoderQ3,
      encQ0Raw: commonPacket.enc_q0_raw ?? commonPacket.encoderQ0Raw ?? commonPacket.enc_q0 ?? commonPacket.encoderQ0,
      encQ1Raw: commonPacket.enc_q1_raw ?? commonPacket.encoderQ1Raw ?? commonPacket.enc_q1 ?? commonPacket.encoderQ1,
      encQ2Raw: commonPacket.enc_q2_raw ?? commonPacket.encoderQ2Raw ?? commonPacket.enc_q2 ?? commonPacket.encoderQ2,
      encQ3Raw: commonPacket.enc_q3_raw ?? commonPacket.encoderQ3Raw ?? commonPacket.enc_q3 ?? commonPacket.encoderQ3,
      encoderRollAligned: commonPacket.enc_valid ? commonPacket.enc_roll_aligned_deg : null,
      encoderPitchAligned: commonPacket.enc_valid ? commonPacket.enc_pitch_aligned_deg : null,
      encoderYawAligned: commonPacket.enc_valid ? commonPacket.enc_yaw_aligned_deg : null,
      encQ0Aligned: commonPacket.enc_valid ? commonPacket.enc_q0_aligned : null,
      encQ1Aligned: commonPacket.enc_valid ? commonPacket.enc_q1_aligned : null,
      encQ2Aligned: commonPacket.enc_valid ? commonPacket.enc_q2_aligned : null,
      encQ3Aligned: commonPacket.enc_valid ? commonPacket.enc_q3_aligned : null,
      dotRaw: commonPacket.dot_raw,
      dotAbs: commonPacket.dot_abs,
      thetaErr: commonPacket.theta_err_deg,
