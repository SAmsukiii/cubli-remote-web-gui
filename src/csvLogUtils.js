...
export const DEFAULT_CSV_LOG_COLUMNS = [
  ...
  'enc_pitch_raw_deg',
  'enc_yaw_raw_deg',
  'enc_roll_aligned_deg',
  'enc_pitch_aligned_deg',
  'enc_yaw_aligned_deg',
  'dot_raw',
  'dot_abs',
  'theta_err_deg',
...
function encoderOnlyPacket(packet = {}, metadata = {}) {
  ...
  return {
    ...
    enc_q0_raw: packet.enc_q0_raw ?? packet.encoderQ0Raw ?? encoder.q0Raw ?? packet.enc_q0 ?? packet.encoderQ0 ?? encoder.q0 ?? '',
    enc_q1_raw: packet.enc_q1_raw ?? packet.encoderQ1Raw ?? encoder.q1Raw ?? packet.enc_q1 ?? packet.encoderQ1 ?? encoder.q1 ?? '',
    enc_q2_raw: packet.enc_q2_raw ?? packet.encoderQ2Raw ?? encoder.q2Raw ?? packet.enc_q2 ?? packet.encoderQ2 ?? encoder.q2 ?? '',
    enc_q3_raw: packet.enc_q3_raw ?? packet.encoderQ3Raw ?? encoder.q3Raw ?? packet.enc_q3 ?? packet.encoderQ3 ?? encoder.q3 ?? '',
    enc_q0_aligned: packet.enc_q0_aligned ?? packet.encoderQ0Aligned ?? encoder.q0Aligned ?? '',
    enc_q1_aligned: packet.enc_q1_aligned ?? packet.encoderQ1Aligned ?? encoder.q1Aligned ?? '',
    enc_q2_aligned: packet.enc_q2_aligned ?? packet.encoderQ2Aligned ?? encoder.q2Aligned ?? '',
    enc_q3_aligned: packet.enc_q3_aligned ?? packet.encoderQ3Aligned ?? encoder.q3Aligned ?? '',
    ...
    enc_roll_raw_deg: packet.enc_roll_raw_deg ?? packet.encoderRollDeg ?? encoder.rollDeg ?? '',
    enc_pitch_raw_deg: packet.enc_pitch_raw_deg ?? packet.encoderPitchDeg ?? encoder.pitchDeg ?? '',
    enc_yaw_raw_deg: packet.enc_yaw_raw_deg ?? packet.encoderYawDeg ?? encoder.yawDeg ?? '',
    enc_roll_aligned_deg: packet.enc_roll_aligned_deg ?? packet.encoderRollAlignedDeg ?? encoder.rollAlignedDeg ?? '',
    enc_pitch_aligned_deg: packet.enc_pitch_aligned_deg ?? packet.encoderPitchAlignedDeg ?? encoder.pitchAlignedDeg ?? '',
    enc_yaw_aligned_deg: packet.enc_yaw_aligned_deg ?? packet.encoderYawAlignedDeg ?? encoder.yawAlignedDeg ?? '',
    dot_raw: packet.dot_raw ?? packet.dotRaw ?? encoder.dotRaw ?? '',
    dot_abs: packet.dot_abs ?? packet.dotAbs ?? encoder.dotAbs ?? '',
    theta_err_deg: packet.theta_err_deg ?? packet.thetaErrDeg ?? encoder.thetaErrDeg ?? '',
    enc_age_ms: packet.enc_age_ms ?? packet.encAgeMs ?? encoder.alignmentAgeMs ?? '',
    enc_valid: packet.enc_valid ?? packet.encValid ?? (encoder.alignmentValid === true ? 1 : encoder.alignmentValid === false ? 0 : ''),
    encoder_alignment_source: packet.encoder_alignment_source ?? packet.encoderAlignmentSource ?? encoder.alignmentSource ?? '',
    ...
    encoder: {
      ...
      q0Raw: packet.enc_q0_raw ?? packet.encoderQ0Raw ?? encoder.q0Raw ?? '',
      q1Raw: packet.enc_q1_raw ?? packet.encoderQ1Raw ?? encoder.q1Raw ?? '',
      q2Raw: packet.enc_q2_raw ?? packet.encoderQ2Raw ?? encoder.q2Raw ?? '',
      q3Raw: packet.enc_q3_raw ?? packet.encoderQ3Raw ?? encoder.q3Raw ?? '',
      q0Aligned: packet.enc_q0_aligned ?? packet.encoderQ0Aligned ?? encoder.q0Aligned ?? '',
      q1Aligned: packet.enc_q1_aligned ?? packet.encoderQ1Aligned ?? encoder.q1Aligned ?? '',
      q2Aligned: packet.enc_q2_aligned ?? packet.encoderQ2Aligned ?? encoder.q2Aligned ?? '',
      q3Aligned: packet.enc_q3_aligned ?? packet.encoderQ3Aligned ?? encoder.q3Aligned ?? '',
      rollRawDeg: packet.enc_roll_raw_deg ?? packet.encoderRollDeg ?? encoder.rollDeg ?? '',
      pitchRawDeg: packet.enc_pitch_raw_deg ?? packet.encoderPitchDeg ?? encoder.pitchDeg ?? '',
      yawRawDeg: packet.enc_yaw_raw_deg ?? packet.encoderYawDeg ?? encoder.yawDeg ?? '',
      rollAlignedDeg: packet.enc_roll_aligned_deg ?? packet.encoderRollAlignedDeg ?? encoder.rollAlignedDeg ?? '',
      pitchAlignedDeg: packet.enc_pitch_aligned_deg ?? packet.encoderPitchAlignedDeg ?? encoder.pitchAlignedDeg ?? '',
      yawAlignedDeg: packet.enc_yaw_aligned_deg ?? packet.encoderYawAlignedDeg ?? encoder.yawAlignedDeg ?? '',
      dotRaw: packet.dot_raw ?? packet.dotRaw ?? encoder.dotRaw ?? '',
      dotAbs: packet.dot_abs ?? packet.dotAbs ?? encoder.dotAbs ?? '',
      thetaErrDeg: packet.theta_err_deg ?? packet.thetaErrDeg ?? encoder.thetaErrDeg ?? '',
      alignmentAgeMs: packet.enc_age_ms ?? packet.encAgeMs ?? encoder.alignmentAgeMs ?? '',
      alignmentValid: packet.enc_valid ?? packet.encValid ?? encoder.alignmentValid ?? '',
      alignmentSource: packet.encoder_alignment_source ?? packet.encoderAlignmentSource ?? encoder.alignmentSource ?? '',
...
export function normalizeCsvPacketForColumns(packet = {}) {
  ...
  return {
    ...
    enc_q0_raw: source.enc_q0_raw ?? source.encoderQ0Raw ?? source.encoder?.q0Raw ?? source.enc_q0 ?? source.encoderQ0 ?? source.encoder?.q0,
    enc_q1_raw: source.enc_q1_raw ?? source.encoderQ1Raw ?? source.encoder?.q1Raw ?? source.enc_q1 ?? source.encoderQ1 ?? source.encoder?.q1,
    enc_q2_raw: source.enc_q2_raw ?? source.encoderQ2Raw ?? source.encoder?.q2Raw ?? source.enc_q2 ?? source.encoderQ2 ?? source.encoder?.q2,
    enc_q3_raw: source.enc_q3_raw ?? source.encoderQ3Raw ?? source.encoder?.q3Raw ?? source.enc_q3 ?? source.encoderQ3 ?? source.encoder?.q3,
    enc_q0_aligned: source.enc_q0_aligned ?? source.encoderQ0Aligned ?? source.encoder?.q0Aligned,
    enc_q1_aligned: source.enc_q1_aligned ?? source.encoderQ1Aligned ?? source.encoder?.q1Aligned,
    enc_q2_aligned: source.enc_q2_aligned ?? source.encoderQ2Aligned ?? source.encoder?.q2Aligned,
    enc_q3_aligned: source.enc_q3_aligned ?? source.encoderQ3Aligned ?? source.encoder?.q3Aligned,
    ...
    enc_roll_raw_deg: source.enc_roll_raw_deg ?? source.encoderRollDeg ?? source.encoder?.rollDeg,
    enc_pitch_raw_deg: source.enc_pitch_raw_deg ?? source.encoderPitchDeg ?? source.encoder?.pitchDeg,
    enc_yaw_raw_deg: source.enc_yaw_raw_deg ?? source.encoderYawDeg ?? source.encoder?.yawDeg,
    enc_roll_aligned_deg: source.enc_roll_aligned_deg ?? source.encoderRollAlignedDeg ?? source.encoder?.rollAlignedDeg,
    enc_pitch_aligned_deg: source.enc_pitch_aligned_deg ?? source.encoderPitchAlignedDeg ?? source.encoder?.pitchAlignedDeg,
    enc_yaw_aligned_deg: source.enc_yaw_aligned_deg ?? source.encoderYawAlignedDeg ?? source.encoder?.yawAlignedDeg,
    dot_raw: source.dot_raw ?? source.dotRaw ?? source.encoder?.dotRaw,
    dot_abs: source.dot_abs ?? source.dotAbs ?? source.encoder?.dotAbs,
    theta_err_deg: source.theta_err_deg ?? source.thetaErrDeg ?? source.encoder?.thetaErrDeg,
    enc_age_ms: source.enc_age_ms ?? source.encAgeMs ?? source.encoder?.alignmentAgeMs,
    enc_valid: source.enc_valid ?? source.encValid ?? (source.encoder?.alignmentValid === true ? 1 : source.encoder?.alignmentValid === false ? 0 : undefined),
    encoder_alignment_source: source.encoder_alignment_source ?? source.encoderAlignmentSource ?? source.encoder?.alignmentSource,
