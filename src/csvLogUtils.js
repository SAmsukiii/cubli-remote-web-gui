...
export function normalizeCsvPacketForColumns(packet = {}) {
  ...
  return {
    ...
    enc_q0: sampleType === 'ENC' ? '' : (source.enc_q0 ?? source.encoderQ0 ?? source.encoder?.q0),
    enc_q1: sampleType === 'ENC' ? '' : (source.enc_q1 ?? source.encoderQ1 ?? source.encoder?.q1),
    enc_q2: sampleType === 'ENC' ? '' : (source.enc_q2 ?? source.encoderQ2 ?? source.encoder?.q2),
    enc_q3: sampleType === 'ENC' ? '' : (source.enc_q3 ?? source.encoderQ3 ?? source.encoder?.q3),
    encoder_roll_deg: sampleType === 'ENC' ? '' : (source.encoderRollDeg ?? source.encoder?.rollDeg),
    encoder_pitch_deg: sampleType === 'ENC' ? '' : (source.encoderPitchDeg ?? source.encoder?.pitchDeg),
    encoder_yaw_deg: sampleType === 'ENC' ? '' : (source.encoderYawDeg ?? source.encoder?.yawDeg),
    encoder_raw_roll_deg: sampleType === 'ENC' ? '' : (source.encoderRawRollDeg ?? source.encoder?.rawRollDeg),
    encoder_raw_pitch_deg: sampleType === 'ENC' ? '' : (source.encoderRawPitchDeg ?? source.encoder?.rawPitchDeg),
    encoder_raw_yaw_deg: sampleType === 'ENC' ? '' : (source.encoderRawYawDeg ?? source.encoder?.rawYawDeg),
    encoder_display_roll_sign: sampleType === 'ENC' ? '' : (source.encoderDisplayRollSign ?? source.encoder?.displayRollSign),
    encoder_display_pitch_sign: sampleType === 'ENC' ? '' : (source.encoderDisplayPitchSign ?? source.encoder?.displayPitchSign),
    encoder_display_yaw_sign: sampleType === 'ENC' ? '' : (source.encoderDisplayYawSign ?? source.encoder?.displayYawSign),
    encoder_euler_sequence: sampleType === 'ENC' ? '' : (source.encoderEulerSequence ?? source.encoder?.eulerSequence),
    encoder_rpy_source: sampleType === 'ENC' ? '' : (source.encoderRpySource ?? source.encoder?.rpySource),
